...
# gem 'postgres_ext-serializers', git: 'https://github.com/crossroads/postgres_ext-serializers.git', branch: 'rebased-with-upstream'
# gem 'postgres_ext-serializers', path: "/home/swat/EMBER/GOODCITY-HK/postgres_ext-serializers"
